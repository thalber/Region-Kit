...
namespace RegionKit.Objects
{
	public class Drawable : CosmeticSprite
	{
		...
		public override void InitiateSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam)
		{
			...
			TriangleMesh mesh = new("Futile_White", triangles, true)
			{
				UVvertices = {
					[0] = new Vector2(0, 0),
					[1] = new Vector2(1, 0),
		...
		public override void DrawSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam, float timeStacker, Vector2 camPos)
		{
			...
			catch (FutileException)
			{
				try
				{
					WWW www = new(string.Concat("file:///", Custom.RootFolderDirectory(), "Assets", Path.DirectorySeparatorChar, "Futile", Path.DirectorySeparatorChar, "Resources", Path.DirectorySeparatorChar, "Decals", Path.DirectorySeparatorChar, Data.GetValue<string>("spriteName"), ".png"));
			...
			Color col = Data.GetValue<Color>("colour");
		...
		{
			PlacedObjectsManager.RegisterFullyManagedObjectType(Fields, typeof(Drawable), "FreeformDecalOrSprite");
		}
	}
}
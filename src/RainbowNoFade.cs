...
namespace RegionKit
{
	...
	public class RainbowNoFade : CosmeticSprite
	{
		...
		private RainbowNoFade.RainbowNoFadeData RBData => this.placedObject.data as RainbowNoFade.RainbowNoFadeData;
		...
		public override void InitiateSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam)
		{
			...
			{
				shader = rCam.game.rainWorld.Shaders["Rainbow"]
			};
		...
		public class RainbowNoFadeData : PlacedObject.ResizableObjectData
		{
			...
			public float Chance => this.fades[5];
	...
	public class RainbowNoFadeRepresentation : ResizeableObjectRepresentation
	{
		...
		public class RainbowNoFadeControlPanel : Panel
		{
			...
			public RainbowNoFade.RainbowNoFadeData RainbowNoFadeData => (this.parentNode as RainbowNoFadeRepresentation).pObj.data as RainbowNoFade.RainbowNoFadeData;
			public class FadeSlider : Slider
			{
				...
				public RainbowNoFade.RainbowNoFadeData RainbowNoFadeData => (this.parentNode.parentNode as RainbowNoFadeRepresentation).pObj.data as RainbowNoFade.RainbowNoFadeData;
				public override void Refresh()
				{
					base.Refresh();
